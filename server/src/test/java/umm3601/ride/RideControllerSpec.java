...
//    String jsonResult = rideController.addNewRide("Good Driver", "Far, Far Away", "The RFC", false, true,"2020-04-07", "5:00 PM","30", "We're never coming back.", "5ca243f0db41ec9258d40336", riderList, "4");
...
//    Map<String, String[]> emptyMap = new HashMap<>();
//    //Test good update
//    Boolean resp = rideController.updateRide(knownId.toString(), "Christian", "Milwaukee", "Arizona", false, false,"2019-04-01TT05:00:00.000Z", "03:00", "30", "Lets Go!", "4");
...
//    //Test bad update
//    Boolean badResp = rideController.updateRide(new ObjectId().toString(), "Christian2", "Milwaukee", "Arizona", false, true,"2019-04-01TT05:00:00.000Z","14:05","100", "Lets Go!", "4");
